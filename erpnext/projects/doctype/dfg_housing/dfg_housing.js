...
frappe.ui.form.on("DFG Activity Tasks", {
...
frappe.ui.form.on("DFG Housing", "refresh", function(frm) {
...
function calculate_duration(cur_frm, from_date, to_date) {
        frappe.call({
                method: "erpnext.projects.doctype.dfg_housing.dfg_housing.calculate_durations",
                 args: {
